...
const sessions: Session[] = [
    ...
    },
    {
        ...
        "cta": "Asistir a esta sesión te permitirá obtener una visión práctica sobre cómo construir y optimizar aplicaciones en la nube utilizando servicios de Amazon Web Services. Aprenderás sobre la creación de un MVP, la modernización mediante Auto Scaling y la implementación de soluciones innovadoras con Machine Learning. Esta sesión está diseñada para desarrolladores, arquitectos de soluciones y emprendedores interesados en mejorar sus habilidades en el desarrollo en la nube y en la implementación de tecnologías avanzadas.",
    ...
    },
    {
        ...
        "cta": "Deberías asistir a esta sesión porque abordará los desafíos comunes que enfrentan muchos profesionales al trabajar con AWS, especialmente en lo que respecta a la gestión de permisos de IAM. Aprenderás sobre la importancia de utilizar roles de IAM en lugar de credenciales programáticas para invocar funciones Lambda desde aplicaciones de terceros, así como los riesgos asociados con el uso de endpoints públicos.Esta sesión está diseñada para profesionales que trabajan en roles relacionados con DevOps, Data Engineering, MLOps y cualquier persona interesada en mejorar la seguridad y eficiencia de su arquitectura en la nube.",
        ...
        "speakerPhotoUrl": "https://dhttps://day.awscommunity.mx/assets/images/speakers/gerardo_moreno.jpgay.awscommunity.mx/assets/images/speakers/gerardo_moreno.jpg",
    ...
    },
    {
        ...
        "cta": "Asistir a esta sesión te permitirá aprender sobre un patrón probado para la infraestructura como código basada en CDK, lo que facilitará la creación de pilas de CloudFormation claras y escalables. Aprenderás a aplicar principios de las 12-factor apps para la separación de configuraciones y modularización de pilas, lo que reducirá la complejidad de las pilas monolíticas y permitirá diferenciación de entornos mediante argumentos de línea de comandos.Esta sesión está diseñada para desarrolladores, ingenieros de DevOps y arquitectos de soluciones que buscan mejorar sus habilidades en la automatización de despliegues en entornos de Kubernetes y AWS, así como aquellos que desean optimizar la integración de CDK en sus entornos de CI/CD.",
        ...
        "descriptionSpanish": "Esta charla presenta un patrón de implementación de CDK inspirado en la \"aplicación de 12 factores\", centrándose en la separación de la configuración y la modularización de la pila.Abordaremos técnicas para reducir la complejidad de las pilas monolíticas, aplicando principios de separación de preocupaciones y permitiendo la diferenciación de entornos a través de argumentos de línea de comandos. Esto facilita la integración de CDK en entornos comunes de CI/CD como GitHub Actions, GitLab CI/CD o Harness.Usaremos el despliegue de una VPC, un clúster de EKS y Karpenter, utilizando CDKs para demostrar el patrón y la estructura del proyecto, cubriendo:• VPC: Análisis de una arquitectura de 3 subredes y su implementación en CDK.• CDKs Cómo pasar contextos a Sub Stacks, como la VPC.• EKS: Nuevos métodos de autenticación con CDK:◦ Transferencia de contexto entre las pilas de VPC y EKS.◦ Migración de ConfigMap a la API de Entradas de Acceso.◦ Implementación de Identidades de Pod para autenticar recursos de kubernetes a AWS IAM.◦ Karpenter: Ventajas en el escalado automático de EKS, impacto en costos y velocidad de escalado.",
    ...
    },
    {
        ...
        "cta": "Asistir a esta sesión es una oportunidad única para entender en profundidad la tecnología detrás de la computación serverless, específicamente Firecracker. Aprenderás cómo se crean máquinas virtuales ligeras y seguras, y cómo esta tecnología está revolucionando los servicios como AWS Lambda y Fargate. La sesión está diseñada para desarrolladores y profesionales de TI que buscan mejorar su comprensión sobre la infraestructura de los servicios serverless y optimizar sus prácticas en la nube.",
